...
<body>
    ...
    <section style="padding:170px">
        ...
        <center><h1>Envoyer Reclamation</h1></center>
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input  type="text" name="description" id="description" maxlength="2000" class="form-control" >
</div>
        
            <div class="form-group">
                <label for="idrec">Idrec</label>
                <input  type="text" name="idrec" id="idrec" maxlength="20" class="form-control">
            </div>
            <br>
